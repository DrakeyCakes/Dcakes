	...
	function cntctfrm_display_form( $atts = array( 'lang' => 'en' ) ) {
		...
		if ( true !== $cntctfrm_result ) { 
			...
			if ( isset( $error_message['error_form'] ) ) { 
				$content .= '<div style="text-align: left; color: red;" class="errormsg">' . $error_message['error_form'].'</div>';
			}
			...
			if ( $cntctfrm_options['cntctfrm_display_name_field'] == 1 ) { 
				...
				if ( isset( $error_message['error_name'] ) ) {
					$content .= '<div style="text-align: left; color: red;" class="errormsg">' . $error_message['error_name'] . '</div>';
				}
			...
			if ( $cntctfrm_options['cntctfrm_display_address_field'] == 1 ) { 
				...
				if( isset( $error_message['error_address'] ) ) {
					$content .= '<div style="text-align: left; color: red;" class="errormsg">' . $error_message['error_address'] . '</div>';
				}
				$content .= '<div style="text-align: left;">
			...
			if ( isset( $error_message['error_email'] ) ) {
				$content .= '<div style="text-align: left; color: red;" class="errormsg">' . $error_message['error_email'] . '</div>';
			}
			$content .= '<div style="text-align: left;">
			...
			if ( $cntctfrm_options['cntctfrm_display_phone_field'] == 1 ) { 
				...
				if ( isset( $error_message['error_phone'] ) ) {
					$content .= '<div style="text-align: left; color: red;" class="errormsg">' . $error_message['error_phone'] . '</div>';
				}
				$content .= '<div style="text-align: left;">
			...
			if ( isset( $error_message['error_subject'] ) ) {
				$content .= '<div style="text-align: left; color: red;" class="errormsg">' . $error_message['error_subject'] . '</div>';
			}
			$content .= '<div style="text-align: left;">
			...
			if ( isset( $error_message['error_message'] ) ) {
				$content .= '<div style="text-align: left; color: red;" class="errormsg">' . $error_message['error_message'] . '</div>';
			}
			$content .= '<div style="text-align: left;">
			...
			if ( $cntctfrm_options['cntctfrm_attachment'] == 1 ) {
				...
				if ( isset( $error_message['error_attachment'] ) ) {
					$content .= '<div style="text-align: left; color: red;" class="errormsg">' . $error_message['error_attachment'] . '</div>';
				}
				$content .= '<div style="text-align: left;">
